...
a2 = Album.create!(title: "Sick Haze", artist_id: u2.id, year: 1982, description: "Ready to space out? Vague 80's synths and trippy guitar odysseys", image: File.open('app/assets/images/album-art-images/sickhaze.jpeg'))
...
a6 = Album.create!(title: "Randomonium", artist_id: u5.id, year: 2010, description: "A collection of lead singer Kelby Lu's most heart-wrenching vocal melodies", image: File.open('app/assets/images/album-art-images/randomonium.jpeg'))
...
a8 = Album.create!(title: "Everyone Sign In?", artist_id: u7.id, year: 2012, description: "Sardonic, whimsical, addicting entertainment", image: File.open('app/assets/images/album-art-images/everyonesignin-corsky.jpeg'))
a9 = Album.create!(title: "The Dirty X", artist_id: u8.id, year: 2000, description: "Uncertified Lifeguards debut EP shows that they don't play by the rules.", image: File.open('app/assets/images/album-art-images/thedirtyx.jpeg'))
a10 = Album.create!(title: "Flirting With Termination", artist_id: u8.id, year: 2001, description: "The Lifeguards are back with some afro grooves and tropical vibes.", image: File.open('app/assets/images/album-art-images/flirtingwithtermination.jpeg'))
a11 = Album.create!(title: "Shakshukah", artist_id: u9.id, year: 2015, description: "Just KBTS showing off their specific Brooklyn-brand of catchy EDM", image: File.open('app/assets/images/album-art-images/shakshukah.jpeg'))
