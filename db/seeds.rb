...
a1 = Album.create!(title: "Childhood and Shame", artist_id: u1.id, year: 1995, description: "A solid 90s rock album with spoken word interludes and spine-tingling power chord riffs")
...
a4 = Album.create!(title: "Thank You 39th Street", artist_id: u4.id, year: 2014, description: "Energizing and fresh alternative take on the modern world, featuring a creative mix of genres and heart-felt, genuine lyrics")
...
a9 = Album.create!(title: "The Dirty X", artist_id: u8.id, year: 2000, description: "Uncertified Lifeguards debut EP shows that they don't play by the rules.")
a10 = Album.create!(title: "Flirting With Termination", artist_id: u8.id, year: 2001, description: "The Lifeguards are back with some afro grooves and tropical vibes.")
a11 = Album.create!(title: "Shakshukah", artist_id: u9.id, year: 2015, description: "Just KBTS showing off their specific Brooklyn-brand of catchy EDM")
a12 = Album.create!(title: "Southern Exposure", artist_id: u9.id, year: 2011, description: "Drummer Val Ery and frontman Wictor Vu are as brilliant as ever, delivering songs brimming with unkempt emotion.")
a13 = Album.create!(title: "Straight Outta Denny's", artist_id: u10.id, year: 2012, description: "What can only be described as 'muscular hip-hop' with confrontational, unabashed lyrics")
a14 = Album.create!(title: "Merging State", artist_id: u8.id, year: 2017, description: "Uncertified, unmatched, unforgiving classical-meets-dubstep combination as the Lifeguards pivot genres.")
a15 = Album.create!(title: "My Vacation Squeeze", artist_id: u11.id, year: 1991, description: "The hip-hop 'Sublime-esque' duo from Malibu share their warm, big-hearted feel with jangling guitar and earnest pseudo-rapping.")
